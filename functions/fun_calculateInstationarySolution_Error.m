function [T_plot] = fun_calculateInstationarySolution_Error(...
                    ...
                    saveInstationary, totalTime)
% This function is used for the time analysis. 
global h
...
counterMax = totalTime; % To break out of while loop
counter = 0; % to start while loop
...
if counter == counterMax
    ...
    disp(['' num2str(counter/3600) ' hours to have passed.'])
    disp('Maximum number of iterations reached.')
    disp(['Running time for instationary: ' num2str(time) ' s.'])
else
    disp('End of calculation for instationary solution.')
    disp(['It took ' num2str(counter/3600) ' hours to reach the set temperature.'])
    disp(['It took ' num2str(counter/deltaT) ' iterations to reach the set temperature.'])
    disp(['Running time for instationary: ' num2str(time) ' s.'])
end
